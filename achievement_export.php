<?php
  ...
  if($sem == 'odd')
  {
    $sql = "SELECT student_registration_number,student_name,year,semester,section,achievements,academic_year,
  ...
  $columnheader = '';
  $columnheader = "Reg.No"."\t"."Name"."\t"."Year"."\t"."Semester"."\t"."Section"."\t"."Position"."\t"."Academic year"
                  ."\t"."Event"."\t"."Venue"."\t"."Place"."\t"."From"."\t"."To"."\t"."Periods";
  $setdata ='';
  ...
  header("Content-Disposition: attachment; filename=achievement_report.xls");
